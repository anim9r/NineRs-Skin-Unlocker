    ...
    [5] = {
        ...
        [1] = {
            ...
            [2] = {"Button", "Save Config", function()
                    game:GetService("nixus cb").ConfigEvent:Fire("SaveConfig", o["Configs"]["Configs"]["Configs_Name"])
                end, {text = "Save"}, "Save_Config"},
            [3] = {"Button", "Load Config", function()
                    game:GetService("nixus cb").ConfigEvent:Fire("LoadConfig", o["Configs"]["Configs"]["Configs_Name"])
